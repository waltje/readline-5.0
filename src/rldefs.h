...
#else
READLINE_API int _rl_stricmp PARAMS((char *, char *));
READLINE_API int _rl_strnicmp PARAMS((char *, char *, int));
#endif

#if defined (HAVE_STRPBRK) && !defined (HAVE_MULTIBYTE)
#  define _rl_strpbrk(a,b)	strpbrk((a),(b))
#else
READLINE_API char *_rl_strpbrk PARAMS((const char *, const char *));
#endif
...
READLINE_API char *_rl_get_user_registry_string (char *keyName, char* valName);

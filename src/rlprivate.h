...
READLINE_API int readline_echoing_p;
...
READLINE_API void _rl_move_cursor_relative PARAMS((int, const char *));
...
READLINE_API void _rl_clear_screen PARAMS((void));
...
/* misc.c */
READLINE_API int _rl_init_argument PARAMS((void));
...
/* bind.c */
READLINE_API const char *_rl_possible_control_prefixes[];
READLINE_API const char *_rl_possible_meta_prefixes[];
...
READLINE_API procenv_t readline_top_level;

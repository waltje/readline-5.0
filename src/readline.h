...
#define STR_CATSTR(x,y) 0x0##x##0##y
#define STR(x) STR_STRING(x)
#define STRCAT(x,y) STR_CATSTR(x,y)

/* Hex-encoded Readline version number. */
#define RL_VERSION_MAJOR	5
#define RL_VERSION_MINOR	1
#define RL_READLINE_VERSION	STRCAT(RL_VERSION_MAJOR,RL_VERSION_MINOR)
#define RL_LIBRARY_VERSION      STR(RL_VERSION_MAJOR.RL_VERSION_MINOR)
...
READLINE_API void rl_putc PARAMS((int, FILE *));
...
/* The address of the function to call to display a character on the current
   Readline output stream */
READLINE_API rl_putc_func_t *rl_putc_function;
